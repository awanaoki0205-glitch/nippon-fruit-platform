...
class NF_Customer_Portal {
    ...
    public static function restrict_admin() {
        ...
        $allowed_pages = array('nf-customer-dashboard','nf-customer-easy-settings','nf-customer-display','nf-customer-category-order','nf-customer-contract','nf-customer-intelligence','nf-product-intelligence','nf-customer-analytics');
    ...
    public static function parent_file($parent_file) {
        ...
        $taxonomy = sanitize_key($_GET['taxonomy'] ?? '');
        if (
            in_array($page, array('nf-customer-dashboard','nf-customer-easy-settings','nf-customer-display','nf-customer-category-order','nf-customer-contract','nf-customer-intelligence','nf-product-intelligence','nf-customer-analytics'), true) ||
